...
--
-- Current Database: `vehicle_service_db`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `vehicle_service_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `booking_services` VALUES (1,1,3500.00),(1,3,2400.00),(2,2,1850.00),(2,5,2250.00),(3,4,1200.00),(3,6,950.00),(4,1,3500.00);
...
INSERT INTO `bookings` VALUES (1,'VSB-2026-1001',4,1,1,1,'2026-09-20','09:00 AM - 11:00 AM','repair','Slight brake vibration at 60 km/h and regular 25K service.','2026-09-20 13:41:02',5900.00,'2026-09-20 05:11:02','2026-09-20 05:11:02'),(2,'VSB-2026-1002',4,2,2,6,'2026-09-18','10:00 AM - 12:00 PM','completed','AC cooling was slow. Full service and coolant flush performed.','2026-09-18 10:41:02',4100.00,'2026-09-20 05:11:02','2026-09-20 05:11:02'),(3,'VSB-2026-1003',5,3,1,2,'2026-09-20','11:30 AM - 01:30 PM','inspection','Electric powertrain routine 15k check & wheel alignment.','2026-09-20 15:41:02',2150.00,'2026-09-20 05:11:02','2026-09-20 05:11:02'),(4,'VSB-2026-1004',5,4,3,8,'2026-09-22','09:00 AM - 11:00 AM','booked','Off-road pre-trip full suspension and brake checkup.',NULL,3500.00,'2026-09-20 05:11:02','2026-09-20 05:11:02');
...
INSERT INTO `invoice_items` VALUES (1,1,'Synthetic Engine Oil & Filter Change','service',1,1850.00,1850.00),(2,1,'Climate Control & AC Deep Servicing','service',1,2250.00,2250.00),(3,1,'OEM Activated Charcoal AC Cabin Filter','part',1,650.00,650.00),(4,2,'Periodic Maintenance Service (25K)','service',1,3500.00,3500.00),(5,2,'Braking System Overhaul','service',1,2400.00,2400.00),(6,2,'Front Ceramic Brake Pads (Set of 4)','part',1,1800.00,1800.00);
...
INSERT INTO `invoices` VALUES (1,'INV-2026-0891',2,4,4100.00,738.00,200.00,4638.00,'paid','UPI / Card','2026-09-18 05:11:02'),(2,'INV-2026-0892',1,4,5900.00,1062.00,300.00,6662.00,'unpaid','Pending Checkout','2026-09-20 05:11:02');
...
INSERT INTO `job_assignments` VALUES (1,1,2,'in_progress','2026-09-20 03:11:02',NULL,'Inspected brake discs; replacing front ceramic pads and ongoing general fluid service.'),(2,2,3,'completed','2026-09-18 05:11:02','2026-09-18 07:11:02','AC refrigerant topped up to 450g; cabin filter replaced; test drive verified 4°C vent temp.'),(3,3,2,'assigned','2026-09-20 04:41:02',NULL,'EV battery health report generated (98.4% SOH); moving to alignment bay.');
...
INSERT INTO `notifications` VALUES (1,4,1,'sms','Booking Confirmed - VSB-2026-1001','Dear Revanth Reddy, your slot for Hyundai Creta (TS 09 EA 4521) is confirmed for today 09:00 AM at Jubilee Hills.','delivered','2026-09-20 01:11:02'),(2,4,1,'email','Vehicle Checked-In - Bay 2','Your Creta is checked in. Inspection has commenced under Lead Mechanic Vikram Singh.','sent','2026-09-20 02:11:02'),(3,4,1,'sms','Repair Stage Started','Vehicle has entered the Repair bay. Estimated completion time is today by 03:00 PM.','delivered','2026-09-20 04:11:02'),(4,4,2,'email','Service Completed & Invoice Ready','Service on your Honda City is complete! Digital Invoice INV-2026-0891 is ready for viewing.','sent','2026-09-18 05:11:02'),(5,5,3,'sms','Check-In Confirmed - Tata Nexon EV','Subhash, your Nexon EV has reached the inspection bay at Hyderabad Central Hub.','delivered','2026-09-20 04:11:02');
...
INSERT INTO `service_history_logs` VALUES (1,1,NULL,'booked',4,'Online booking confirmed via Customer Portal.','2026-09-20 01:11:02'),(2,1,'booked','checked_in',1,'Vehicle arrived at Jubilee Hills Bay 2. Odometer reading 24,510 km logged.','2026-09-20 02:11:02'),(3,1,'checked_in','inspection',2,'Initial visual inspection completed. Found minor wear on front brake pads.','2026-09-20 03:11:02'),(4,1,'inspection','repair',2,'Front brake pad replacement underway. Engine oil drain in progress.','2026-09-20 04:11:02'),(5,2,NULL,'booked',4,'Service slot booked online.','2026-09-17 05:11:02'),(6,2,'booked','checked_in',1,'Vehicle checked in at Hitech City center.','2026-09-18 05:11:02'),(7,2,'checked_in','inspection',3,'Diagnostic check indicated AC refrigerant drop and clogged cabin pollen filter.','2026-09-18 03:11:02'),(8,2,'inspection','repair',3,'Flushed refrigerant, leak tested at 250 psi, replaced pollen filter.','2026-09-18 05:11:02'),(9,2,'repair','quality_check',3,'Quality inspector passed road cooling test and cabin air purity test.','2026-09-18 06:11:02'),(10,2,'ready_for_delivery','completed',1,'Payment settled and vehicle handed over to customer.','2026-09-18 07:11:02'),(11,3,NULL,'booked',5,'Online appointment scheduled.','2026-09-20 00:11:02'),(12,3,'booked','checked_in',1,'Nexon EV received at Express Station.','2026-09-20 04:11:02'),(13,3,'checked_in','inspection',2,'High-voltage battery diagnostic scanner connected.','2026-09-20 04:51:02'),(14,4,NULL,'booked',5,'Booking confirmed for upcoming expedition preparation.','2026-09-19 05:11:02');
...
INSERT INTO `service_slots` VALUES (1,1,'2026-09-20','09:00 AM - 11:00 AM',6,2),(2,1,'2026-09-20','11:30 AM - 01:30 PM',6,1),(3,1,'2026-09-20','02:30 PM - 04:30 PM',6,0),(4,1,'2026-09-21','09:00 AM - 11:00 AM',6,1),(5,1,'2026-09-21','11:30 AM - 01:30 PM',6,0),(6,2,'2026-09-20','10:00 AM - 12:00 PM',4,1),(7,2,'2026-09-21','02:00 PM - 04:00 PM',4,0),(8,3,'2026-09-22','09:00 AM - 11:00 AM',8,1);
...
INSERT INTO `users` VALUES (1,'Rajesh Varma (Service Director)','rajesh@apexautohub.com','$2a$10$PI.x1JQky3PnTNZqV9Uxi.1nCSt7zxZWKCFZ4cpnLsYPcgx.NhS4q','admin','+91 98765 43210','2026-09-20 05:11:02','2026-09-20 05:11:02'),(2,'Vikram Singh (Lead Mechanic)','vikram@apexautohub.com','$2a$10$g4FWpmPx.6jWb6qNUuZVbuXah7toLoGRFqVNgo3XhgXwprP.I5IUC','staff','+91 98765 43211','2026-09-20 05:11:02','2026-09-20 05:11:02'),(3,'Ananya Iyer (Diagnostic Specialist)','ananya@apexautohub.com','$2a$10$YZ6S9JKBT32kU9qEunAj4OF8jU2/uwlxJyRFfV9O.cqTiM/ar366u','staff','+91 98765 43212','2026-09-20 05:11:02','2026-09-20 05:11:02'),(4,'Revanth Reddy','revanth@vehicleservice.com','$2a$10$Dri/IARpbO4k9zJHI0iqUuPLWPDbyL6SOWtLspV4vJlIyrfdPyQrm','customer','+91 98765 43213','2026-09-20 05:11:02','2026-09-20 05:11:02'),(5,'Subhash','subhash@vehicleservice.com','$2a$10$Dri/IARpbO4k9zJHI0iqUuPLWPDbyL6SOWtLspV4vJlIyrfdPyQrm','customer','+91 98765 43214','2026-09-20 05:11:02','2026-09-20 05:11:02');
...
INSERT INTO `vehicles` VALUES (1,4,'TS 09 EA 4521','Hyundai','Creta SX(O)',2022,'Petrol',24500,'Phantom Black','2026-09-20 05:11:02'),(2,4,'TS 07 HK 1088','Honda','City ZX',2021,'Petrol',38200,'Platinum White Pearl','2026-09-20 05:11:02'),(3,5,'TS 08 FJ 9912','Tata','Nexon EV Empowered',2023,'Electric',16400,'Empowered Oxide','2026-09-20 05:11:02'),(4,5,'AP 29 BR 3341','Mahindra','Thar 4x4',2022,'Diesel',29000,'Red Rage','2026-09-20 05:11:02');
...
-- Dump completed on 2026-09-20 11:09:03
